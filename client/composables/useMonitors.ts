...
export function useMonitors() {
  ...
  const fetchMonitors = async () => {
    ...
    try {
      ...
      const response = await fetch(`${config.public.apiBaseUrl}/api/v1/monitors`, {
        method: 'GET',
        headers: {
  ...
  const fetchMonitor = async (id: string) => {
    loading.value = true
    error.value = null
    ...
    try {
      ...
      const response = await fetch(`${config.public.apiBaseUrl}/api/v1/monitors/${id}`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  // Create monitor
  const createMonitor = async (payload: CreateMonitorPayload) => {
    loading.value = true
    error.value = null
  ...
  // Update monitor
  const updateMonitor = async (id: string, payload: UpdateMonitorPayload) => {
    loading.value = true
    error.value = null
  ...
  // Fetch monitor logs
  const fetchMonitorLogs = async (id: string, limit: number = 50, offset: number = 0) => {
    loading.value = true
    error.value = null
    ...
    try {
      ...
      const response = await fetch(`${config.public.apiBaseUrl}/api/v1/monitors/${id}/logs?limit=${limit}&offset=${offset}`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
