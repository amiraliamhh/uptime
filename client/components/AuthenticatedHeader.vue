        ...
        <div class="flex items-center space-x-4">
          ...
          <div v-if="isAuthenticated" class="relative">
            ...
            >
              ...
              <span class="max-w-[150px] truncate">{{ selectedOrganization?.name || (organizations.length > 0 ? 'Select Organization' : 'No Organization') }}</span>
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            >
              ...
              <div class="max-h-64 overflow-y-auto">
                <div v-if="organizations.length === 0" class="px-4 py-3 text-sm text-gray-500 dark:text-gray-400 text-center">
          ...
          <div v-if="isAuthenticated" class="flex items-center space-x-2">
            ...
            <span class="text-sm font-medium text-gray-700 dark:text-gray-200">{{ user?.name || user?.email || 'Loading...' }}</span>
          </div>
        </div>
      </div>
    </nav>
...
onMounted(async () => {
  if (isAuthenticated.value) {
    ...
    // Always try to fetch organizations
